...
<div class="admintitle">
    ...
    <h1 align='center' style=" color:white; font-size:50px;text-shadow: 0.1em 0.1em 0.15em black;">Search Data Information</h1>
</div>
    ...
    <table width='80%' border="1px solid" style="margin-left: auto; margin-right:auto; margin-top:30px; font-weight:bold;border-spacing: 5px 5px;">
        ...
        ?>
                <tr align="center">
                    ...
                    <td><a href="datadeleted.php?bb=<?php echo $data['billno']; ?>" style=" color:blue;">Delete</a></td>
                </tr>
        <?php
            }
        }
