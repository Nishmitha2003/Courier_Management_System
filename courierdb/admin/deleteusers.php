...
<div class="admintitle">
    ...
    <h1 align='center' style=" color:white; font-size:50px;text-shadow: 0.1em 0.1em 0.15em black;">Showing All Users</h1>
</div>
    ...
    <table width='80%' border="1px solid" style="margin-left: auto; margin-right:auto; margin-top:30px; font-weight:bold;border-collapse: collapse;">
        ...
        ?>
                <tr align="center">
                    ...
                    <td><a href="usersdeleted.php?emm=<?php echo $data['email']; ?>" style=" color:blue;">DeleteUser</a></td>
                </tr>
        <?php
            }
        }
