    ...
    <form action="courierMenu.php" method="POST" enctype="multipart/form-data">
        <div style="overflow-x:auto;">
            <table border="0px solid" style="margin: auto; font-weight:bold;border-spacing: 5px 15px;">
                <th colspan="4" style="text-align: center;background-color:yellow; width: 140px; height: 50px;">Fill The Details Of Sender & Receiver</th>
                <tr>
                ...
                <tr>
                    ...
                    <tr>
                    <td>Item Price:</td>
                    <td><input type="number" name="iprice" placeholder="item price" required></td>
                ...
                <tr>
                    ...
                    <td>delivery Date:</td>
                    <td><input type="date" name="ddate" value="<?php echo date('Y-m-d',strtotime("tomorrow")); ?>" readonly /></td>
